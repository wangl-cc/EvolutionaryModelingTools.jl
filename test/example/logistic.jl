...
g_result = run_gillespie(MersenneTwister(1), T)[1].n
g_result_record = run_gillespie_record(MersenneTwister(1), T)[1].n
m_result = run_manually(MersenneTwister(1))
m_result_record = run_manually_record(MersenneTwister(1), T)
